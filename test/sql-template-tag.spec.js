...
describe('SQL template tag', () => {
  it('collects values and write placeholders', () => {
    ...
    assert.strictEqual(literal.text, 'foo $1 $2 bar $3');
  ...
  it('accepts nested literals', () => {
    ...
    assert.strictEqual(literal.text, 'foo bar $1 $2 baz foobar $3 $4');
  ...
  it('does not interpolate escaped identifiers or literals', () => {
    ...
    assert.strictEqual(literal.text, 'foo "bar"  E\'b\\\\az\' bat');
